#!/usr/bin/env python3
# Copyright (c) 2014-2020 Wladimir J. van der Laan
...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef AYCH_CHAINPARAMSSEEDS_H\n')
    g.write('#define AYCH_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    ...
    g.write('#endif // AYCH_CHAINPARAMSSEEDS_H\n')
